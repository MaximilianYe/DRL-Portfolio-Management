...
from envs.env_v1_cont_act_sp import SimpleUSStockEnv, prepare_stocks_from_list
...
def start_ppo_training():
    ...
    stock_features = ['market_uptrend', 'market_volatility', 'momentum_10d_percentile', 'RSI', 'volatility_22d', 'standard_price', 'momentum_5d']
